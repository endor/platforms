...
var cloneAttendanceAttributes =  cloneAttributesFunction(['version', 'id', 'target_username', 'target_user_id', 'source_username', 'source_user_id']);

var instance_methods = {
  toDoc: function(db, callback) {
    return _(cloneAttendanceAttributes(this)).extend({_id: ContactRequest.toId(this.target_user_id + this.source_user_id), type: 'ContactRequest'});
  },
  toApi: function() {
